...
<header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ">
                ...
                <li class="nav-item">
                    <a class="nav-link customStyle" href="family.php"><i class="fa-solid fa-magnifying-glass"></i> Bachelor</a>
                </li>
                <li class="nav-item">
    ...
    <section>
        <div class="container mb-4">
            <h3 class="main-heading animate__animated animate__flipInX">Bachelor</h3>
