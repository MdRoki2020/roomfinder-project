...
<title>Bachelor-Room-Details</title>
</head>
<body>
<header>
    ...
    <?php
    $selectQuery="SELECT * FROM `bachelor` WHERE `id`='$id'";
                ...
                <div class="row animate__animated animate__zoomIn">
                    <div class="col-sm-4">
                        <div class="SingleProductImage">
                            <img id="zoom_01" width="350" height="250" class="zoom img-fluid img-thumbnail" src="publisher/bachelor_room_images/<?php echo $row['photo']?>" data-zoom-image="publisher/bachelor_room_images/<?php echo $row['photo']?>"/>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        ...
                        <div class="buttonWrapper mb-3">
                            <a href="b_ensure.php?id=<?php echo $row['id']?>"><button class="btn btn-primary "><i class="fas fa-shopping-bag"></i> Ensure</button></a>
                        </div>
                    </div>
                    <div class="col-sm-4">
